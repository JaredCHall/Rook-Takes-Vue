...
describe('MoveNotary' , () => {
    ...
    it('it formats simple pawn moves' , () => {
        ...
        expect(notary.getSanNotation()).toEqual('e5')
    })
    ...
    it('it adds disambiguation' , () => {
        ...
        expect(notary.getSanNotation()).toEqual('de5')
    })
    ...
    it('it formats pawn captures' , () => {
        ...
        expect(notary.getSanNotation()).toEqual('fxe5')
    })
    ...
    it('it formats piece captures' , () => {
        ...
        let notary = new MoveNotary(move, fenAfter, '')
        expect(notary.getSanNotation()).toEqual('Nxg6')
    })
    ...
    it('it marks pawn promotions' , () => {
        ...
        let notary = new MoveNotary(move, fenAfter, '')
        expect(notary.getSanNotation()).toEqual('d8=N#')
    })
    ...
    it('it marks castling moves' , () => {
        ...
        let notary = new MoveNotary(move, fenAfter, '')
        expect(notary.getSanNotation()).toEqual('O-O-O+')
        ...
        expect(notary.getSanNotation()).toEqual('O-O')
